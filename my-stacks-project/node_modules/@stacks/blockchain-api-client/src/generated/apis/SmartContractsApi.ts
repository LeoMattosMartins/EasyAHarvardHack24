...
export interface SmartContractsApiInterface {
     ...
     * @memberof SmartContractsApiInterface
     */
    getContractByIdRaw(requestParameters: GetContractByIdRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<object>>;

    /**
     * Retrieves details of a contract with a given `contract_id`
     * Get contract info
     */
    getContractById(requestParameters: GetContractByIdRequest, initOverrides?: RequestInit): Promise<object>;
...
export class SmartContractsApi extends runtime.BaseAPI implements SmartContractsApiInterface {
     ...
     * Get contract info
     */
    async getContractByIdRaw(requestParameters: GetContractByIdRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<object>> {
     ...
     * Get contract info
     */
    async getContractById(requestParameters: GetContractByIdRequest, initOverrides?: RequestInit): Promise<object> {
