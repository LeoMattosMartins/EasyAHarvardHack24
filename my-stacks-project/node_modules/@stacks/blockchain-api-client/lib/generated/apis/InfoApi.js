...
class InfoApi extends runtime.BaseAPI {
    ...
    async getStatusRaw(initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ServerStatusResponseFromJSON(jsonValue));
    }
    /**
     * Retrieves the running status of the Stacks Blockchain API, including the server version and current chain tip information.
     * API status
    ...
    async getStxSupplyRaw(requestParameters, initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => models_1.GetStxSupplyResponseFromJSON(jsonValue));
    }
    /**
     * Retrieves the total and unlocked STX supply. More information on Stacking can be found [here] (https://docs.stacks.co/understand-stacks/stacking).
     * Get total and unlocked STX supply
    ...
    async getTotalStxSupplyLegacyFormatRaw(requestParameters, initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => models_1.GetStxSupplyLegacyFormatResponseFromJSON(jsonValue));
    }
    /**
     * Retrieves total supply of STX tokens including those currently in circulation that have been unlocked.
     * Get total and unlocked STX supply (results formatted the same as the legacy 1.0 API)
