...
function BnsGetNameInfoResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'expire_block': !runtime_1.exists(json, 'expire_block') ? undefined : json['expire_block'],
        'grace_period': !runtime_1.exists(json, 'grace_period') ? undefined : json['grace_period'],
        'last_txid': json['last_txid'],
        'resolver': !runtime_1.exists(json, 'resolver') ? undefined : json['resolver'],
        'status': json['status'],
