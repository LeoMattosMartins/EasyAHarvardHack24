...
function AddressBalanceResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'stx': _1.StxBalanceFromJSON(json['stx']),
        'fungible_tokens': json['fungible_tokens'],
        'non_fungible_tokens': json['non_fungible_tokens'],
        'token_offering_locked': !runtime_1.exists(json, 'token_offering_locked') ? undefined : _1.AddressTokenOfferingLockedFromJSON(json['token_offering_locked']),
    };
}
...
function AddressBalanceResponseToJSON(value) {
    ...
    return {
        'stx': _1.StxBalanceToJSON(value.stx),
        'fungible_tokens': value.fungible_tokens,
        'non_fungible_tokens': value.non_fungible_tokens,
        'token_offering_locked': _1.AddressTokenOfferingLockedToJSON(value.token_offering_locked),
    };
}
