...
function RosettaConstructionDeriveResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'account_identifier': !runtime_1.exists(json, 'account_identifier') ? undefined : _1.RosettaAccountIdentifierFromJSON(json['account_identifier']),
...
function RosettaConstructionDeriveResponseToJSON(value) {
    ...
    return {
        ...
        'account_identifier': _1.RosettaAccountIdentifierToJSON(value.account_identifier),
