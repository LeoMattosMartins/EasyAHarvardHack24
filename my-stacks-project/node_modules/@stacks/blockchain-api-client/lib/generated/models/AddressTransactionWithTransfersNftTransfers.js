...
function AddressTransactionWithTransfersNftTransfersFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'value': _1.AddressTransactionWithTransfersValueFromJSON(json['value']),
        'sender': !runtime_1.exists(json, 'sender') ? undefined : json['sender'],
        'recipient': !runtime_1.exists(json, 'recipient') ? undefined : json['recipient'],
    };
}
...
function AddressTransactionWithTransfersNftTransfersToJSON(value) {
    ...
    return {
        ...
        'value': _1.AddressTransactionWithTransfersValueToJSON(value.value),
        'sender': value.sender,
