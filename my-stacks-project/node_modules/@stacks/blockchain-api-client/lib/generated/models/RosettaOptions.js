...
function RosettaOptionsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'number_of_cycles': !runtime_1.exists(json, 'number_of_cycles') ? undefined : json['number_of_cycles'],
        'contract_address': !runtime_1.exists(json, 'contract_address') ? undefined : json['contract_address'],
        'contract_name': !runtime_1.exists(json, 'contract_name') ? undefined : json['contract_name'],
        'burn_block_height': !runtime_1.exists(json, 'burn_block_height') ? undefined : json['burn_block_height'],
        'delegate_to': !runtime_1.exists(json, 'delegate_to') ? undefined : json['delegate_to'],
        'pox_addr': !runtime_1.exists(json, 'pox_addr') ? undefined : json['pox_addr'],
    };
}
