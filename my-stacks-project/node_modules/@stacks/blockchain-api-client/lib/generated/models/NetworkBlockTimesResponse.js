...
function NetworkBlockTimesResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'mainnet': _1.TargetBlockTimeFromJSON(json['mainnet']),
        'testnet': _1.TargetBlockTimeFromJSON(json['testnet']),
    };
}
...
function NetworkBlockTimesResponseToJSON(value) {
    ...
    return {
        'mainnet': _1.TargetBlockTimeToJSON(value.mainnet),
        'testnet': _1.TargetBlockTimeToJSON(value.testnet),
    };
}
