...
exports.CLI_ARGS = {
    ...
    properties: {
            ...
            items: [
                {
                    ...
                    pattern: exports.NAMESPACE_PATTERN,
                },
            ],
            minItems: 1,
            maxItems: 1,
        ...
        get_app_keys: {
            ...
            minItems: 3,
            maxItems: 3,
            help: 'Get the application private key from a 12- or 24-word Secret Key and an index of the enumerated associated accounts.  ' +
        ...
        migrate_subdomains: {
            ...
            minItems: 1,
            maxItems: 2,
            help: 'Enable users to transfer subdomains currently owned by any data-key \n' +
            ...
            items: [
                {
                    ...
                    type: 'string',
                    realtype: 'id-address',
                    pattern: exports.ID_ADDRESS_PATTERN,
                },
            ],
            minItems: 1,
            maxItems: 1,
        ...
        profile_sign: {
            ...
            items: [
                ...
                },
                {
                    ...
                    type: 'string',
                    realtype: 'private_key',
                    pattern: exports.PRIVATE_KEY_PATTERN,
                },
            ],
            minItems: 2,
            maxItems: 2,
            ...
            items: [
                {
                    ...
                    pattern: `${exports.NAME_PATTERN}|${exports.SUBDOMAIN_PATTERN}|${exports.ID_ADDRESS_PATTERN}`,
                },
                {
                    name: 'profile',
                    type: 'string',
        ...
        profile_verify: {
            ...
            items: [
                ...
                },
                {
                    ...
                    type: 'string',
                    realtype: 'id-address',
                    pattern: `${exports.ID_ADDRESS_PATTERN}|${exports.PUBLIC_KEY_PATTERN}`,
                },
            ],
            minItems: 2,
            maxItems: 2,
...
exports.USAGE = `Usage: ${process.argv[1]} [options] command [command arguments]
Options can be:
    -c                  Path to a config file (defaults to
                        ${exports.DEFAULT_CONFIG_PATH})
    ...
    -M MAX_INDEX        Maximum keychain index to use when searching for an identity address
                        (default is ${exports.DEFAULT_MAX_ID_SEARCH_INDEX}).
...
function formatCommandHelpLines(commandName, commandArgs) {
    ...
    let kwUsage = '';
    let kwPad = '';
    const commandInfo = exports.CLI_ARGS.properties[commandName];
...
function getCommandGroups() {
    const groups = {};
    const commands = Object.keys(exports.CLI_ARGS.properties);
    for (let i = 0; i < commands.length; i++) {
        const command = commands[i];
        const group = exports.CLI_ARGS.properties[command].group;
        if (!groups.hasOwnProperty(group)) {
            groups[group] = [
                {
                    command: command,
                    help: exports.CLI_ARGS.properties[command].help,
                },
            ];
        }
        else {
...
exports.makeAllCommandsList = makeAllCommandsList;
...
exports.makeAllCommandsHelp = makeAllCommandsHelp;
function makeCommandUsageString(command) {
    ...
    const commandInfo = exports.CLI_ARGS.properties[command];
...
exports.makeCommandUsageString = makeCommandUsageString;
function makeUsageString() {
    let res = `${exports.USAGE}\n\nCommand reference\n`;
    const groups = getCommandGroups();
    const groupNames = Object.keys(groups).sort();
    for (let i = 0; i < groupNames.length; i++) {
...
exports.makeUsageString = makeUsageString;
function printUsage() {
    console.error(makeUsageString());
}
exports.printUsage = printUsage;
function getCLIOpts(argv, opts = 'deitlUxC:F:B:P:D:G:N:H:T:I:m:M:X:u:p:c:') {
    const optsTable = {};
    const remainingArgv = [];
...
exports.CLIOptAsString = CLIOptAsString;
...
exports.CLIOptAsBool = CLIOptAsBool;
...
exports.CLIOptAsStringArray = CLIOptAsStringArray;
function getCommandArgs(command, argsList) {
    let commandProps = exports.CLI_ARGS.properties[command].items;
...
function checkArgs(argList) {
    ...
    if (!exports.CLI_ARGS.properties.hasOwnProperty(commandName)) {
        return {
            success: false,
    ...
    const commandSchema = JSON.parse(JSON.stringify(exports.CLI_ARGS.properties[commandName]));
