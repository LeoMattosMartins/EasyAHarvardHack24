...
export declare const DEFAULT_CONFIG_TESTNET_PATH: string;
...
export declare function getCommandArgs(command: string, argsList: string[]): {
    status: boolean;
    error: string;
    arguments?: undefined;
} | {
...
export declare function checkArgs(argList: string[]): CheckArgsSuccessType | CheckArgsFailType;
